      ...
      <section className="section-white mt-16">
        <div className="container mx-auto">
          <div className="text-center">
            <h2 className="text-4xl font-bold mb-4">The Team Behind HealthConnect</h2>
          </div>
